...
Il [servizio automated forms conversion](../help/introduction.md) converte i seguenti moduli sorgente in moduli adattivi:
...
1. [Eseguire la conversione](../help/convert-existing-forms-to-adaptive-forms.md) sul modulo PDF non interattivo per generare un modulo adattivo.
