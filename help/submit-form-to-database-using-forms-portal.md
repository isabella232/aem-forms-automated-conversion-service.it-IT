...
# Integrazione di moduli adattivi con il database utilizzando Forms Portal {#submit-forms-to-database-using-forms-portal}
...
1. Andate su http://[server]:[porta]/system/console/depfinder e cercate il pacchetto com.mysql.jdbc.
...
1. Andate su http://[server]:[porta]/system/console/bundle e fate clic su **[!UICONTROL Install/Update]**.
...
1. Create una tabella **data** nello schema del database utilizzando la seguente istruzione SQL:
...
1. Create una tabella **metadata** nello schema del database utilizzando la seguente istruzione SQL:
...
1. Create una tabella **ulteriore metadati** nello schema del database utilizzando la seguente istruzione SQL:
...
1. Create una tabella **commenttable** nello schema del database utilizzando la seguente istruzione SQL:
...
1. Vai alla pagina AEM configurazione della console Web all&#39;indirizzo *http://[host]:[port]/system/console/configMgr*.
...
1. Lasciate invariate le altre configurazioni e fate clic su **[!UICONTROL Save]**.
...
## Configurare il modulo adattivo convertito per l&#39;integrazione di Forms Portal {#configure-converted-adaptive-form-for-forms-portal-integration}

Per abilitare l&#39;invio di moduli adattivi tramite la pagina Forms Portal, eseguite i seguenti passaggi:
1. [Eseguire la ](convert-existing-forms-to-adaptive-forms.md#start-the-conversion-process) conversione per convertire un modulo sorgente in un modulo adattivo.
1. Aprire il modulo adattivo in modalità di modifica.
1. Toccare Contenitore modulo e selezionare Configura ![Configura modulo adattivo](assets/configure-adaptive-form.png).
...
1. Toccate ![Salva criteri modello](assets/edit_template_done.png) per salvare le impostazioni.
...
1. Toccate Contenitore di layout e toccate ![Modifica criterio modello](assets/edit_template_policy.png). Nella scheda **[!UICONTROL Allowed Components]**, abilitare le opzioni **[!UICONTROL Document Services]** e **[!UICONTROL Document Services Predicates]**, quindi toccare ![Salva criteri modello](assets/edit_template_done.png).
1. Inserire il componente **[!UICONTROL Search & Lister]** nella pagina. Di conseguenza, tutti i moduli adattivi esistenti disponibili nell&#39;istanza di AEM sono elencati nella pagina.
1. Inserire il componente **[!UICONTROL Drafts & Submissions]** nella pagina. Nella pagina Forms Portal sono visualizzate due schede, **[!UICONTROL Draft Forms]** e **[!UICONTROL Submitted Forms]**. La scheda **[!UICONTROL Draft Forms]** visualizza anche il modulo adattivo convertito generato utilizzando i passaggi indicati in [Configurare il modulo adattivo convertito per l&#39;integrazione con Forms Portal](#configure-converted-adaptive-form-for-forms-portal-integration)
